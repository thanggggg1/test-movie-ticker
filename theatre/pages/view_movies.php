            ...
            <div class="box-body">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="todo-list">
                            <?php
                            $qry7 = mysqli_query($con, "select * from tbl_movie where release_date <= CURDATE()");
                            ...
                            ?>
                                    <li>
                                        ...
                                        <div class="tools">
                                            ...
                                            <a href="view_shows.php?mid=<?php echo $c['movie_id']; ?>"> <button style="border-color:transparent;">View all shows of the movie</button></a>
                                        </div>
                                    </li>
                            <?php
                                }
